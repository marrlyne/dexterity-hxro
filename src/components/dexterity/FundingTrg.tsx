  ...
  return (
    <div className="flex flex-col justify-center items-center border border-white rounded-lg p-4 mt-4">
      ...
      <div className="w-full flex flex-col items-center mt-20 mb-6">
        <label htmlFor="amountInput" className="text-xl font-semibold mb-1">
          Amount
        </label>
        <input
          id="amountInput"
      ...
      <div className="flex justify-center space-x-4 w-full mt-12">
        <button
          ...
          className={`group text-md w-30 m-2 btn ${
            amount !== null
              ? "bg-gradient-to-br  from-[#80ff7d] to-[#80ff7d] hover:from-white hover:to-purple-300 text-black"
        ...
        <button
          ...
          className={`group text-md w-30 m-2 btn ${
            amount !== null
              ? "bg-gradient-to-br from-[#ff80f2] to-[#ff80f2] hover:from-white hover:to-purple-300 text-black"
              : "bg-gray-300 cursor-not-allowed"
          }`}
          disabled={amount === null || isLoading}
        >
